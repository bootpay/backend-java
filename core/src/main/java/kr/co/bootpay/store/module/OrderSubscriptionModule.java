...
public class OrderSubscriptionModule {
    ...
    /**
     * 구독 해지 (supervisor 권한) — 위약금·환불액·서비스 종료일 등 정산 항목 지정.
     *
     * @param orderSubscriptionId 구독 id
     ...
     * @throws Exception 통신 실패 또는 인증 정보 누락
     */
    public BootpayResponse supervisorTerminate(String orderSubscriptionId, SupervisorTerminateParams params) throws Exception {
        return CommerceResponses.of(delegate.supervisorTerminate(orderSubscriptionId, params));
    }
